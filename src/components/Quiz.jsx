      ...
      <div className="md:w-9/12 w-[90%] flex md:flex-row flex-col mx-auto">
        ...
        <div className="md:w-[70%] w-full">
          <div>
            {questions.map((question, index) => (
              ...
              >
                <p className="flex items-center rounded text-xs p-2 cursor-pointer">
                  <span className="h-8 w-8 bg-[#227dfc] rounded-full flex justify-center items-center text-green-800 mr-3">
                    {index + 1}
                  </span>
            ...
            <button onClick={handleSubmit} className="bg-[#227dfc] px-6 py-2 text-white rounded">
              Submit Quiz
            </button>
          </div>
        </div>
        ...
        <div className="md:w-[30%] w-full p-4">
          {showResult && (
            <div>
              ...
              <button
                onClick={restartQuiz}
                className="bg-[#227dfc] text-white w-full py-2 rounded mt-16"
              >
                Restart
              </button>
            </div>
